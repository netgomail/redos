    ...
    <Frame width={width} subtitle={subtitle}>
      ...
      {st.outdated && (
        <Box flexDirection="column" marginBottom={1}>
          ...
          <Box paddingLeft={4}>
            <Text color="gray" dimColor>
              Примените заново: на машине лежат старые скрипт и правило, исправления
              новой версии (рубеж по блочному узлу, принтеры HP, диски только на USB)
              заработают после повторного применения
            </Text>
          </Box>
        </Box>
      )}
