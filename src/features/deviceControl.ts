 ...
 *  3. прогоняем через правило уже подключённые устройства;
 *  4. ПРОВЕРКА: каждое устройство ввода, разрешённое до применения, разрешено
 *     и после; потерявшим доступ возвращаем его точечно.
 *
 * Шаг 4 страхует и от ошибки в самой политике: если разрешение класса HID
...
export async function applyPolicy(
  ...
  // 3. Сетка безопасности по устройствам ввода
